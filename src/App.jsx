    ...
    steps: [
      {
        ...
        choices: [
          'A. 行動規範・意思決定基準・社内外への価値観発信（求心力）として機能する',
          'B. 財務目標の代替として活用する文書',
          'C. 株主向けの形式的なIR文書',
          'D. 就業規則と同等の拘束力を持つ規範',
        ],
      ...
      },
      {
        ...
        choices: [
          'A. 採用基準への反映・評価制度との連動・朝礼や研修での継続的な共有',
          'B. 社長が年1回全社員に向けて読み上げるだけ',
          'C. 文書を壁に掲示するだけ',
          'D. 外部向けホームページにのみ掲載する',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. ①共有（採用・研修）②評価への反映（理念行動を考課）③権限委譲（現場での理念実践）',
          'B. 財務指標の改善のみを重視する',
          'C. 不要な人員を削減して理念共有を促す',
          'D. 設備投資で生産性を高めることで理念が自然に浸透する',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. 意思決定が速い・長期視点での経営が可能・経営理念の継承がしやすい',
          'B. ガバナンス体制が整備されやすい',
          'C. 後継者育成の仕組みが自然に整う',
          'D. 外部からの資金調達が非常に有利になる',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 身内登用による能力主義の歪み・ガバナンス弱体化・組織硬直化のリスク',
          'B. 意思決定が遅くなる',
          'C. 外部資本が入りすぎて独立性が失われる',
          'D. 経営理念が不明確になりやすい',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. ①後継者の早期育成②段階的な権限委譲③外部人材の活用④組織の仕組み化（属人性排除）',
          'B. 株価の引き下げだけを検討する',
          'C. 廃業を前提に清算を進める',
          'D. M&Aによる売却のみを選択肢にする',
        ],
    ...
    steps: [
      {
        ...
        choices: [
          'A. 最も有効なリーダーシップスタイルは状況（部下の成熟度・課題の構造）によって異なる',
          'B. 常にPM型リーダーシップが最適である',
          'C. カリスマ性さえあれば状況は関係ない',
          'D. リーダーシップは生来の資質であり後天的に変えられない',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 部下の能力・意欲が低い段階（新人・未経験者）→ 具体的な指示と細かいフィードバックが有効',
          'B. ベテランが多く自律的に動ける職場',
          'C. クリエイティブな業務で裁量が必要な場面',
          'D. 危機的局面すべてに一律に適用する',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 部下の能力・意欲ともに高い段階（熟練者）→ 権限を委譲し自律的に動かせる',
          'B. 新人が多い職場で細かい指示が必要なとき',
          'C. 業務内容が不明確で指示が頻繁に変わるとき',
          'D. 納期が切迫していて全員に細かく指示が必要なとき',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. ①現状の部下成熟度を分析②成熟度に応じたスタイル（指示→コーチング→委任）③OJT・Off-JTの組み合わせ',
          'B. 一律に全員へ権限委譲する',
          'C. 給与アップだけでモチベーションを維持する',
          'D. 能力の低いマネジャーを即座に交代させる',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. 既存の成功体験への執着・変化への心理的抵抗・人事評価制度との不整合',
          'B. 設備の老朽化による生産性低下',
          'C. 市場の縮小による売上減少',
          'D. 競合他社の急増による価格競争',
        ],
      ...
      },
      {
        ...
        choices: [
          'A. 評価制度の見直し（望ましい行動を報いる）と小集団活動での成功体験の積み重ね',
          'B. トップの訓示を増やすだけ',
          'C. 大規模なリストラによる組織スリム化',
          'D. 組織図の名称変更だけ行う',
        ],
      ...
      },
      {
        ...
        choices: [
          'A. 失敗を恐れずに提案・発言できる環境をつくり、改善提案やイノベーションが生まれやすくなる',
          'B. 心理的安全性が高いと生産性が下がる',
          'C. 規律が乱れて組織が機能しなくなる',
          'D. 競争意識が薄れて業績が悪化する',
        ],
    ...
    steps: [
      {
        ...
        choices: [
          'A. 市場規模・成長性・顧客ニーズ・購買決定要因（KBF）・セグメント特性',
          'B. 自社の強み・弱みの把握',
          'C. 競合他社の戦略と価格帯の分析',
          'D. 自社製品の原価構造と利益率',
        ],
      ...
      },
      {
        ...
        choices: [
          'A. 競合の強み・弱み・市場シェア・差別化要因・今後の戦略の方向性',
          'B. 自社の経営資源と中核能力',
          'C. 業界全体の市場規模のみ',
          'D. 顧客の購買履歴データ',
        ],
      ...
      },
      {
        ...
        choices: [
          'A. 顧客ニーズが大きく・競合が対応していない領域で、自社の強みが発揮できるポジションを選ぶ',
          'B. 競合と全く同じ戦略で価格競争に勝つ',
          'C. 市場規模が最大のセグメントに一律参入する',
          'D. 自社の弱みを克服することのみに集中する',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. Attention（注意）→Interest（興味）→Desire（欲求）→Memory（記憶）→Action（行動）',
          'B. Interest→Attention→Desire→Memory→Action',
          'C. Action→Memory→Desire→Interest→Attention（逆順）',
          'D. Attention→Desire→Interest→Memory→Action',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. DesireとMemoryが「Search（検索）」に変わり、ActionのあとにShare（口コミ・SNS拡散）が加わる',
          'B. AIDMAと全く同じプロセスで違いはない',
          'C. Attentionが不要になりSearchから始まる',
          'D. SNS広告費が増えるだけで構造は変わらない',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. Attention＝マス広告・SNS認知施策、Interest＝体験イベント・詳細コンテンツ、Action＝クーポン・限定オファー',
          'B. 全段階に同一の施策を均等に投入する',
          'C. Actionにのみ全プロモーション予算を集中させる',
          'D. Memory段階は広告不要でほっておいてよい',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. 卸・小売などの流通業者に働きかけ（リベート・販促支援）、流通側から消費者へ商品を「押し出す」',
          'B. 消費者向けの大規模広告で需要を作り出す',
          'C. SNSでの口コミを意図的に喚起する施策',
          'D. 消費者が自ら検索してくる仕組みをつくるSEO施策',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. ブランド認知度が高く、消費者自身が指名買いするほど需要喚起できる場合',
          'B. 新製品の市場導入期で認知度がゼロのとき',
          'C. 流通チャネルの開拓が最優先の状況',
          'D. B2B向けの業務用製品の販売',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 低コストで顧客との関係を深めるSNS・口コミ・地域イベント・常連客への紹介施策（プル型中心）',
          'B. 全国テレビCMへの大規模投資',
          'C. 大規模なリベートで流通を支配するプッシュ戦略',
          'D. 価格割引のみで需要を喚起し続ける',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. 産地・地域名称のブランド力を活かして差別化でき、個社では実現できない認知度向上が図れる',
          'B. 地域ブランドを作ればコストが最も安くなる',
          'C. 競合がすべてなくなる',
          'D. 補助金が自動的に支給される',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 互いの顧客基盤・ノウハウ・チャネルを補完し合い、単独では届かない顧客層へリーチする',
          'B. コスト削減が唯一の目的',
          'C. 資本提携が前提となる',
          'D. 合併を前提とした提携のみが有効',
        ],
      ...
      },
      {
        ...
        choices: [
          'A. 多言語対応・SNS発信・体験型コンテンツ・地域資源の観光コンテンツ化・キャッシュレス対応',
          'B. 価格を下げることだけが有効',
          'C. 商品の日本語表示を翻訳するだけで十分',
          'D. 国内客と全く同一の施策で対応する',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. 複数工程を担当できる作業者。繁閑に応じた柔軟な人員配置が可能となり、手待ちロスを削減できる',
          'B. 一つの工程だけを極めた専任の熟練工',
          'C. 管理職候補として選抜された将来の幹部社員',
          'D. 外注先に常駐する熟練した協力工',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 1人または少人数のグループが製品の最初から最後まで担当。多品種少量生産・リードタイム短縮に適する',
          'B. 大量生産向けのライン生産方式と同義',
          'C. コンベア中心の流れ作業で高速生産する方式',
          'D. 外注を多用する分業体制',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. スキルマップで各人の習得状況を見える化し、OJTでローテーションを計画的に実施する',
          'B. 希望者だけ自己学習に任せる',
          'C. 全員を同時に全工程の外部研修に送り出す',
          'D. 外部採用で多能工をまとめて確保する',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. 内段取り＝機械停止中にしかできない作業。外段取り＝機械稼働中にも準備できる作業',
          'B. 内段取り＝社内で行う作業、外段取り＝外注に依頼する作業',
          'C. 内外段取りは場所の違いだけで内容は同じ',
          'D. 内外の区別は実務上あまり意味がない',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. ①内外段取りの分離→②内段取りの外段取り化→③残った内段取りの短縮（標準化・並行作業）',
          'B. まず設備を全て最新型に入れ替える',
          'C. 段取り作業を全て外注化して工場内からなくす',
          'D. 作業者を増やすだけで段取り時間は自然に短縮される',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 小ロット化が可能になり多品種対応力が上がる・リードタイム短縮・仕掛在庫削減',
          'B. 品質のみが向上する',
          'C. 製造コストが必ず上がってしまう',
          'D. 大ロット生産にのみ有効で小ロット生産には関係ない',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. 大日程＝月〜年単位の長期計画、中日程＝週〜月単位、小日程＝日・シフト単位の詳細作業計画',
          'B. 大は設備投資計画・中は人員計画・小は品質計画',
          'C. 三者は同義で同じ計画の別名称に過ぎない',
          'D. 日本固有の概念で国際標準（S&OP等）とは無関係',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 生産計画に対して実績がどの程度進んでいるかを把握し、遅延があれば早期に対処する',
          'B. 製品の品質基準の管理',
          'C. 原材料の発注・在庫管理',
          'D. 設備の稼働率と保全状況の管理',
        ],
      ...
      },
      {
        ...
        choices: [
          'A. 各作業者・設備の現在の負荷と能力の差（余力・不足）を把握し、仕事量を平準化すること',
          'B. 残業時間の上限管理',
          'C. 在庫の余剰分の管理と処分計画',
          'D. 生産コストの余裕分（バッファ）の管理',
        ],
        correct: 0,
    ...
    steps: [
      {
        ...
        choices: [
          'A. 品質・納期・コストの管理に加え、外注先との情報共有・技術支援・長期的パートナーシップの構築',
          'B. 価格交渉だけを重視して最安値業者を選ぶ',
          'C. 常に複数業者を競合させて最安値だけで選定する',
          'D. 外注先の内部管理には一切干渉しない',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. オペレーターも参加した自主保全活動で設備故障ゼロ・不良ゼロ・災害ゼロを目指す',
          'B. 専任の保全担当者のみが設備管理を行う',
          'C. 故障後に修理する事後保全のみで十分',
          'D. TPMはトヨタ生産方式（TPS）と全く同義である',
        ],
        correct: 0,
      ...
      },
      {
        ...
        choices: [
          'A. 重要設備・故障コストが高い設備は予防保全（定期点検・部品交換）、影響の小さい設備は事後保全でコスト効率化',
          'B. 全設備に予防保全が必須でコスト無視で実施する',
          'C. 事後保全の方が常にコストが低くなる',
          'D. 予防保全は大企業にのみ有効で中小企業には不向き',
        ],
        correct: 0,
